...
define(['./workbox-9ba2d447'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/i\.scdn\.co\/.*/i, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^http:\/\/localhost:3001\/.*/i, new workbox.NetworkFirst({
    "cacheName": "api-cache",
